...
export const AuthProvider = ({ children }: { children: React.ReactNode }) => {
  ...
  const refreshUser = useCallback(async () => {
    ...
    try {
      ...
      setUser({ username: data.username, user_type: data.user_type, dept_id: data.dept_id });
      ...
      // ── Always turn off loading, mark first check done ──────────────────
      setLoading(false);
      hasCheckedOnce.current  = true;    // ← after this, loading never goes true again
